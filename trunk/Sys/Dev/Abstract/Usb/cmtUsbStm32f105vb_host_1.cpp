 ...
 ******************************************************************************/
typedef struct _USB_OTGH_GREGS  //000h
{
...
/** @defgroup __otg_Core_registers
  * @{
  */
typedef struct USB_OTGH_CORE_REGS //000h
{
  USB_OTGH_GREGS        *GREGS;
  USB_OTG_HREGS         *HREGS;
...
USB_OTGH_CORE_REGS , *PUSB_OTGH_CORE_REGS;

typedef union _USB_OTGH_GAHBCFG_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved9_31 :
  ...
  b;
} USB_OTGH_GAHBCFG_TypeDef;

typedef union _USB_OTGH_GUSBCFG_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t corrupt_tx :
  ...
  b;
} USB_OTGH_GUSBCFG_TypeDef ;

typedef union _USB_OTGH_GRSTCTL_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t ahbidle :
  ...
  b;
} USB_OTGH_GRSTCTL_TypeDef ;

typedef union _USB_OTGH_GINTMSK_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t wkupintr :
  ...
  b;
} USB_OTGH_GINTMSK_TypeDef;

typedef union _USB_OTGH_GINTSTS_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t wkupintr :
  ...
  b;
} USB_OTGH_GINTSTS_TypeDef;

typedef union _USB_OTGH_HRXSTS_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved :
  ...
  b;
} USB_OTGH_HRXFSTS_TypeDef;

typedef union _USB_OTGH_FSIZ_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t depth :
  ...
  b;
} USB_OTGH_FSIZ_TypeDef;

typedef union _USB_OTGH_GNPTXSTS_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved :
  ...
  b;
} USB_OTGH_GNPTXSTS_TypeDef ;


typedef union _USB_OTGH_GCCFG_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved_out :
  ...
  b;
} USB_OTGH_GCCFG_TypeDef;

typedef union _USB_OTGH_HCFG_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t fslssupp :
  ...
  b;
} USB_OTGH_HCFG_TypeDef;

typedef union _USB_OTGH_HFRMINTRVL_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved :
  ...
  b;
} USB_OTGH_HFRMINTRVL_TypeDef ;

typedef union _USB_OTGH_HFNUM_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t frrem :
  ...
  b;
} USB_OTGH_HFNUM_TypeDef;

typedef union _USB_OTGH_HPTXSTS_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t ptxqtop_odd :
  ...
  b;
} USB_OTGH_HPTXSTS_TypeDef;

typedef union _USB_OTGH_HPRT0_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved19_31 :
  ...
  b;
} USB_OTGH_HPRT0_TypeDef;

typedef union _USB_OTGH_HAINT_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved :
  ...
  b;
} USB_OTGH_HAINT_TypeDef;

typedef union _USB_OTGH_HAINTMSK_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved :
  ...
  b;
} USB_OTGH_HAINTMSK_TypeDef;

typedef union _USB_OTGH_HCCHAR_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t chen :
  ...
  b;
} USB_OTGH_HCCHAR_TypeDef;

typedef union _USB_OTGH_HCSPLT_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved17 :
  ...
  b;
} USB_OTGH_HCSPLT_TypeDef;

typedef union _USB_OTGH_HCINTn_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved :
  ...
  b;
} USB_OTGH_HCINTn_TypeDef;

typedef union _USB_OTGH_HCTSIZn_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Rerserved31 :
  ...
  b;
} USB_OTGH_HCTSIZn_TypeDef;

typedef union _USB_OTGH_HCGINTMSK_TypeDef 
{
  uint32_t d32;
  struct
  {
...
uint32_t Reserved :
  ...
  b;
} USB_OTGH_HCGINTMSK_TypeDef;

typedef union _USB_OTGH_PCGCCTL_TypeDef 
{
  uint32_t d32;
  struct
  {
