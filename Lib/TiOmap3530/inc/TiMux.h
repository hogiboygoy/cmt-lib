...
#define  IEN	(1 << 8) //Разрешить вход
#define  IDIS	(0 << 8) //Запретить вход
#define  PTU	(1 << 4) //Подтяжка вверх
#define  PTD	(0 << 4) //Подтяжка вниз
#define  EN	(1 << 3)   //Разрешить подтяжку
#define  DIS	(0 << 3) //Запретить подтяжку
